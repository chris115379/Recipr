package de.androidbytes.recipr.presentation.overview.favorites.view.adapter;
...
public class FavoritesOverviewAdapter extends BaseAdapter<FavoritesOverviewAdapter.FavoritesOverviewViewHolder, RecipeViewModel> {
    ...
    @Inject
    public FavoritesOverviewAdapter(Context context) {
