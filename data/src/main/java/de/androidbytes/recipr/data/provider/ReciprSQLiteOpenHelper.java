...
public class ReciprSQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String SQL_CREATE_TABLE_CATEGORY = "CREATE TABLE IF NOT EXISTS "
            ...
            + CategoryColumns.USER_ID + " INTEGER NOT NULL, "
            + CategoryColumns.NAME + " TEXT "
            + ", CONSTRAINT fk_user_id FOREIGN KEY (" + CategoryColumns.USER_ID + ") REFERENCES user (_id) ON DELETE RESTRICT"
            + " );";
    ...
    public static final String SQL_CREATE_TABLE_RECIPE = "CREATE TABLE IF NOT EXISTS "
            ...
            + RecipeColumns.CATEGORY_ID + " INTEGER NOT NULL, "
            + RecipeColumns.NAME + " TEXT, "
            + RecipeColumns.FAVORITE + " INTEGER, "
            ...
            + ", CONSTRAINT fk_category_id FOREIGN KEY (" + RecipeColumns.CATEGORY_ID + ") REFERENCES category (_id) ON DELETE RESTRICT"
            + " );";
    ...
    public static final String SQL_CREATE_TABLE_USER = "CREATE TABLE IF NOT EXISTS "
            ...
            + UserColumns.GOOGLE_ID + " TEXT, "
            + UserColumns.NAME + " TEXT NOT NULL, "
            + UserColumns.IMAGE_URL + " TEXT, "
            + UserColumns.LOGGED_IN + " INTEGER NOT NULL"
            + ", CONSTRAINT unique_google_id UNIQUE (" + UserColumns.GOOGLE_ID + ") ON CONFLICT REPLACE"
//            + ", CONSTRAINT unique_name UNIQUE (name) ON CONFLICT ABORT"
            + " );";
