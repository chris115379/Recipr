...
import de.androidbytes.recipr.data.BuildConfig;
import de.androidbytes.recipr.data.provider.base.BaseContentProvider;
...
public class ReciprProvider extends BaseContentProvider {
    ...
    private static final int URI_TYPE_INGREDIENT = 2;
    private static final int URI_TYPE_INGREDIENT_ID = 3;

    private static final int URI_TYPE_RECIPE = 4;
    private static final int URI_TYPE_RECIPE_ID = 5;

    private static final int URI_TYPE_STEP = 6;
    private static final int URI_TYPE_STEP_ID = 7;

    private static final int URI_TYPE_USER = 8;
    private static final int URI_TYPE_USER_ID = 9;
        ...
        switch (matchedId) {
            ...
            case URI_TYPE_CATEGORY_ID:
                ...
                if (UserColumns.hasColumns(projection)) {
                    res.tablesWithJoins += " LEFT OUTER JOIN " + UserColumns.TABLE_NAME + " AS " + CategoryColumns.PREFIX_USER + " ON " + CategoryColumns.TABLE_NAME + "." + CategoryColumns.USER_ID + "=" + CategoryColumns.PREFIX_USER + "." + CategoryColumns._ID;
                }
            ...
            case URI_TYPE_INGREDIENT_ID:
                ...
                if (RecipeColumns.hasColumns(projection) || UserColumns.hasColumns(projection) || CategoryColumns.hasColumns(projection)) {
                ...
                if (CategoryColumns.hasColumns(projection)) {
                    res.tablesWithJoins += " LEFT OUTER JOIN " + CategoryColumns.TABLE_NAME + " AS " + RecipeColumns.PREFIX_CATEGORY + " ON " + IngredientColumns.PREFIX_RECIPE + "." + RecipeColumns.CATEGORY_ID + "=" + RecipeColumns.PREFIX_CATEGORY + "." + CategoryColumns._ID;
                }
            ...
            case URI_TYPE_RECIPE_ID:
                ...
                if (CategoryColumns.hasColumns(projection)) {
                    res.tablesWithJoins += " LEFT OUTER JOIN " + CategoryColumns.TABLE_NAME + " AS " + RecipeColumns.PREFIX_CATEGORY + " ON " + RecipeColumns.TABLE_NAME + "." + RecipeColumns.CATEGORY_ID + "=" + RecipeColumns.PREFIX_CATEGORY + "." + CategoryColumns._ID;
                }
            ...
            case URI_TYPE_STEP_ID:
                ...
                if (CategoryColumns.hasColumns(projection)) {
                    res.tablesWithJoins += " LEFT OUTER JOIN " + CategoryColumns.TABLE_NAME + " AS " + RecipeColumns.PREFIX_CATEGORY + " ON " + StepColumns.PREFIX_RECIPE + "." + RecipeColumns.CATEGORY_ID + "=" + RecipeColumns.PREFIX_CATEGORY + "." + CategoryColumns._ID;
                }
