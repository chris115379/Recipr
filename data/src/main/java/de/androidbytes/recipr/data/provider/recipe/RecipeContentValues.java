...
public class RecipeContentValues extends AbstractContentValues {
    ...
    public RecipeContentValues putCategoryId(long value) {
        mContentValues.put(RecipeColumns.CATEGORY_ID, value);
        return this;
    }
     ...
     */
    public RecipeContentValues putFavorite(@Nullable Boolean value) {
        mContentValues.put(RecipeColumns.FAVORITE, value);
        return this;
    }
